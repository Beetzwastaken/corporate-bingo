...
export const WORD_POOL: Word[] = [
  ...
  {
    id: "like-a-family",
    answer: "like a family",
    display: "Like a Family",
    clues: [
  ...
  {
    id: "fast-paced-environment",
    answer: "fast-paced environment",
  ...
  },
  {
    ...
    answer: "push the envelope",
    display: "Push the Envelope",
    clues: [
  ...
  },
  {
    ...
    answer: "stakeholder buy-in",
    display: "Stakeholder Buy-in",
    clues: [
  ...
  {
    id: "ill-drop-it-in-the-chat",
    answer: "i'll drop it in the chat",
    display: "I'll Drop It in the Chat",
    clues: [
  ...
  {
    id: "lets-not-reinvent-the-wheel",
    answer: "let's not reinvent the wheel",
    display: "Let's Not Reinvent the Wheel",
    clues: [
  ...
  {
    id: "not-to-beat-a-dead-horse",
    answer: "not to beat a dead horse",
    display: "Not to Beat a Dead Horse",
    clues: [
  ...
  {
    id: "let-me-push-back-a-little",
    answer: "let me push back a little",
    display: "Let Me Push Back a Little",
    clues: [
  ...
  },
  {
    ...
    answer: "temperature check",
    display: "Temperature Check",
    clues: [
  ...
  },
  {
    ...
    answer: "boots on the ground",
    display: "Boots on the Ground",
    clues: [
